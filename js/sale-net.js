...
function searchproducts(objid){objid=objid==undefined?"keyword":objid;window.open("search.php?k=" +urlEncode(E(objid).value),'_blank','width=642,height=400,top=20,left=20,toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no,status=no');}
